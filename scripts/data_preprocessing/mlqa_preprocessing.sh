...
if [ ! -z $3 ] 
then
    input_file_name=mlqa_$1_en.parquet
    output_file_name=mlqa_$2_en_$3.json
    sample_size=$3

    python scripts/data_preprocessing/mlqa_preprocessing.py \
    ...
    input_file_name=mlqa_$1_en.parquet
    output_file_name=mlqa_$2_en.json
