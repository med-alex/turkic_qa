...
if 'answers.text' not in data.columns and 'answer.start' not in data.columns:
    data['answers.text'] = data.answers.apply(lambda answer_info: answer_info['text'][0])
    data['answers.answer_start'] = data.answers.apply(lambda answer_info: int(answer_info['answer_start'][0]))
